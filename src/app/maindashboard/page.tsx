...
const ECommerce: React.FC = () => {
  ...
  return (
          <>
            ...
            <Card className="m-4">
              <ChartThree title="Vision 1" series1={vision1Series} title1={`Live Module: ${moduleBarcode1}`} />
            </Card>
            <Card className="m-4">
              <ChartThree title="Vision 2" series1={vision2Series} title1={`Live Module: ${moduleBarcode2}`} />
            </Card>
            <Card className="m-4">
              <ChartThree title="Welding" series1={weldingSeries} title1={`Live Module: ${moduleBarcode3}`} />
            </Card>
            <Card className="m-4">
              <ChartThree title="FPCB Welding" series1={fpcbSeries} title1={`Live Module: ${moduleBarcode4}`} />
            </Card>
            </div>
          </>
        );  
